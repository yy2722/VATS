...
valuesFPS = vertcat(stimInfo(i).frq,relAmp); %concatenates (vertically) only the values of your FPS table/data
FPS = horzcat(labels,valuesFPS); %appends (concatenates) the labels to your table
xlswrite('FPS.xlsx',FPS); %saves the labeled matrix/table as Excel file 
