...
right_songs = dir('C:\Users\labadmin\Desktop\Arduino ARTsy\Testing_songs\preference_songs\training');
left_songs = dir('C:\Users\labadmin\Desktop\Arduino ARTsy\Testing_songs\preference_songs\training');
...
for i=1:(length(right_songs)-2)
    ...
    path_R = fullfile('C:\Users\labadmin\Desktop\Arduino ARTsy\Testing_songs\preference_songs\training', right_songs(i+2).name);
...
for i=1:(length(left_songs)-2)
    ...
    path_L = fullfile('C:\Users\labadmin\Desktop\Arduino ARTsy\Testing_songs\preference_songs\training', left_songs(i+2).name);
...
block_size = int32(300);   %define block size
...
booth = 4;   % Set booth number to indicate the booth that is going to run the experiment
